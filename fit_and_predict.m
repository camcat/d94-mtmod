...
%function [rate ntot ts asig ta r0 inv] = fit_and_predict(cat, inputfile, t0, tnow, tend, [asig0=[0.1 1000]kPa], [ta0=[10 1e6 days], [dt=1day]);

if exist('asig0')~=1 asig0=10; end
if exist('ta0')~=1 ta0=1000; end
